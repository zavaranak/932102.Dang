...
namespace YourBartender
{
    public partial class Form1 : Form
    {
        ...
        public void LauchingWithObjectValue()
        {
            ...
            switch (baseSpirit)
            {
                ...
                case "Gin shot":
                    ...
                    Drink shot = new Drink(product[1], product[2], product[3], product[4], product[5], product[6], product[0], "shot");
                    ...
                    if (tempProducts.Any())
                    {
                        if (tempProducts.Count == 1)
                        {
                            ...
                            param.labels[3].Text = "Base spirit: " + baseSpirit
                                                                   + "\r\nWise choice, getting your order!";
                            param.pictureBoxs[0].Image = Image.FromFile(@"cocktailIMG/" + product[6]);
                            Drink cocktail = new Drink(product[1], product[2], product[3], product[4], product[5], product[6], product[0],"cocktail");
                        ...
                        if (tempProducts.Count > 1)
                        {
                            ...
                            param.comboBox.SelectionChangeCommitted += (sender, args) =>
                            {
                                ...
                                Drink cocktail = new Drink(final[1], final[2], final[3], final[4], final[5], final[6], final[0], "cocktail");
                                servedDrinks.Add(cocktail);
                                listView1.Items.Add(cocktail.Name);
                            }
                                ;
                ...
                case "Beer":
                    ...
                    Drink beer = new Drink("", "", "", "", "", "", "Beer","beer");
        ...
        private void listView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (listView1.SelectedItems.Count > 0)
            {
                ...
                Console.WriteLine("Order at:" + servedDrinks[index].TimeIssue);
                if (servedDrinks[index].Fruit !="") { fruitdetail = " | fruit:" + servedDrinks[index].Fruit; }
                if (servedDrinks[index].Extra != "") { extradetail = " | extra:" + servedDrinks[index].Extra; }
                if (servedDrinks[index].Liqueur != "") { liquerdetail = " | liquer:" + servedDrinks[index].Liqueur; }
                if (servedDrinks[index].Syrup != "") { syrupdetail = " | syrup:" + servedDrinks[index].Syrup; }
                Console.WriteLine("Detail:" + " type:"+servedDrinks[index].Type + fruitdetail + syrupdetail+liquerdetail+extradetail);
            }
    ...
    public struct Drink
    {
        ...
        public Drink(string bs, string fruit, string syrup, string extra, string liqueur, string toCustomer, string name, string type)
        {
            BaseSpririt = bs;
            Extra = extra;
            Fruit = fruit;
            ...
            Type = type;
            TimeIssue = DateTime.Now.ToString("ddd, dd MMM yyy HH’:’mm’:’ss ‘GMT’");
        }
        public override string ToString()
        {
            return $"{Name}";
